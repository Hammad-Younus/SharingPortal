          ...
          <div class="col-sm-12">
            <div class="row">
              <div class="col-sm-8 col-md-9">
                    <aside style="margin-left: -30px;" class="col-sm-4 col-md-3">
...
<!--            <div class="col-sm-12">
            ...
            <div class="clearfix"></div>
              <div class="movie-best">
                 <div class="col-sm-10 col-sm-offset-1 movie-best__rating">Recently Updated</div>
                            ...
                            <div class="movie movie--test movie--test--dark movie--test--left">
                                <div class="movie__images">
                                    <a href="movie-page-left.html" class="movie-beta__link">
                                        <img alt='' src="<?php echo base_url();?>assets/images/movie/movie-time8.jpg">
                                    </a>
                                </div>
                                ...
                                <div class="movie__info">
                                    ...
                                    <div class="movie__rate">
                                        <div class="score" style="cursor: pointer; width: 130px;"><img src="<?php echo base_url();?>assets/images/rate/star-off.svg" alt="1" title="bad">&nbsp;<img src="<?php echo base_url();?>assets/images/rate/star-off.svg" alt="2" title="poor">&nbsp;<img src="<?php echo base_url();?>assets/images/rate/star-off.svg" alt="3" title="regular">&nbsp;<img src="<?php echo base_url();?>assets/images/rate/star-off.svg" alt="4" title="good">&nbsp;<img src="<?php echo base_url();?>assets/images/rate/star-off.svg" alt="5" title="gorgeous"><input type="hidden" name="score"></div>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--left">
                                ...
                                <div class="movie__info">
                                    ...
                                    <div class="movie__rate">
                                         <div class="score" ><img src="<?php echo base_url()?>assets/images/rate/star-off.svg" alt="1" title="bad">&nbsp;<img src="<?php echo base_url();?>assets/images/rate/star-off.svg" alt="2" title="poor">&nbsp;<img src="<?php echo base_url();?>assets/images/rate/star-off.svg" alt="3" title="regular">&nbsp;<img src="<?php echo base_url();?>assets/images/rate/star-off.svg" alt="4" title="good">&nbsp;<img src="<?php echo base_url();?>assets/images/rate/star-off.svg" alt="5" title="gorgeous"><input type="hidden" name="score"></div>
